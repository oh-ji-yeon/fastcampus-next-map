...
interface SearchFilterProps {
  ...
  setDistirct: Dispatch<SetStateAction<string | null>>;
}

export default function SearchFilter({ setQ, setDistirct }: SearchFilterProps) {
  return (
    <div className="flex flex-col md:felx-row gap-2 my-4 ">
      ...
      <select
        onChange={(e) => setDistirct(e.target.value)}
