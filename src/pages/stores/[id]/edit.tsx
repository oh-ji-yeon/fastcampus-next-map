      ...
      onSubmit={handleSubmit(async (data) => {
        try {
          ...
          if (result.status === 200) {
            // 성공 케이스
            toast.success("맛집 수정 완료 ;)");
            // 데이터 생성된 id를 가지고 replace
          ...
          console.log(e);
          toast.error("데이터 수정중 문제가 발생했습니다. 다시 시도해주세요.");
        }
      })}
    >
            ...
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-md border-0 outline-none px-2 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
